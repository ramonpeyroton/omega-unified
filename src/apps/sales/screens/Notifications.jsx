            ...
            {notifications.map((n) => (
              <div
                ...
                className={`p-4 rounded-2xl border transition-all ${
                  !n.seen
                    ? 'bg-omega-pale border-omega-orange/20'
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    {n.jobs && (
                      <p className="text-xs font-semibold text-omega-orange mb-0.5">
                        {n.jobs.client_name}
                      </p>
                    )}
                  ...
                  {!n.seen && (
                    <div className="w-2 h-2 rounded-full bg-omega-orange flex-shrink-0 mt-1.5" />
                  )}
                </div>
              </div>
            ))}
