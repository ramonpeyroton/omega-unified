// MobileMoreSheet — the "More" (•••) overflow menu for the Operations
// mobile bottom bar. The bar keeps Dashboard / Pipeline / Finance /
// Contracts; everything else Brenda reaches (Leads, Calendar,
// Commissions, Subcontractors, Invoice Inbox) lives here, plus Profile
// + Sign Out. Same pattern as the Manager/Owner sheets.

import { useState, useEffect } from 'react';
import { X, ClipboardList, Calendar, DollarSign, Users, Mail, LogOut } from 'lucide-react';
