// MobileMoreSheet — the "More" (•••) overflow menu for the Marketing mobile
// bottom bar. Marketing (Ramon) is read-only with just Pipeline / My Leads /
// Daily Logs, all of which already fit in the bottom bar, so this sheet only
// carries Profile + Sign Out.
//
